...
import methods
import scu_builders
from platform_methods import architecture_aliases, architectures, generate_export_icons
...
env_base = Environment(tools=custom_tools, COMPILATIONDB_USE_ABSPATH=True)
env_base.Tool("compilation_db")
env_base.CompilationDatabase()
